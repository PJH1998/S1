...
public:
	virtual void PlayEffect(UWorld* World, FVector Location, FRotator Rotation, FVector Scale = FVector::OneVector, UNiagaraComponent** OutComponent = nullptr) const override;
