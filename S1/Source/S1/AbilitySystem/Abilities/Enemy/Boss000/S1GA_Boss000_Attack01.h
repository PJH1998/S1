...
#include "S1GA_Boss000_Attack01.generated.h"
 ...
 */
UCLASS()
class S1_API US1GA_Boss000_Attack01 : public US1GA_Enemy
{
	GENERATED_BODY()

public:
	US1GA_Boss000_Attack01(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
